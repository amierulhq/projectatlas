	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $lecturer->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
    ...
    <div class="col-md-3">
        <div class="card shadow border-0 bg-body-tertiary">
            <div class="card-body justify">
                ...
                Please fill in the form accurately and ensure all details are up to date. All staff must:
                    <ul>
                        <li>Provide a valid staff number.</li>
                        <li>Enter the full name as per official records.</li>
                        <li>Ensure the phone number and email address are active and correct.</li>
                    </ul>
