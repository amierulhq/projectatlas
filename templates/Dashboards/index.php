...
<div class="row">
		...
		<div class="d-none d-sm-block">
			<div class="activity-container">
				...
				<div class="image-container img-two">
					<?= $this->Html->image('header/UiTMFacts.png', ['alt' => 'CakePHP']); ?>
					<div class="overlay">
						<h3><a href="https://uitm.edu.my/en/discover-uitm/uitm-facts" class="stretched-link header" target="_blank">UiTMFacts</a></h3>
					</div>
				</div>
				<div class="image-container img-three">
					<?= $this->Html->image('header/ufuture1.png', ['alt' => 'Re-CRUD']); ?>
					<div class="overlay">
						<h3><a href="https://ufuture.uitm.edu.my/login" class="stretched-link header" target="_blank">uFuture</a></h3>
					</div>
				</div>
				<div class="image-container img-four">
					<?= $this->Html->image('header/FSM.png', ['alt' => 'Github']); ?>
					<div class="overlay">
						<h3><a href="https://fis.uitm.edu.my/home" class="stretched-link header" target="_blank">FSM</a></h3>
					</div>
				</div>
				<div class="image-container img-five">
					<?= $this->Html->image('header/alumni1.png', ['alt' => 'CRUD']); ?>
					<div class="overlay">
						<h3><a href="https://myalumnicard.uitm.edu.my/home" class="stretched-link header" target="_blank">Alumni</a></h3>
					</div>
				</div>
				<div class="image-container img-six">
					<?= $this->Html->image('header/mystudent1.png', ['alt' => 'Bootstrap']); ?>
					<div class="overlay">
						<h3><a href="https://mystudent.uitm.edu.my/login" class="stretched-link header" target="_blank">MyStudent</a></h3>
					</div>
				</div>
			</div>
		</div>
  ...
  <div id="autoToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
      <strong class="me-auto">ATLAS Notification</strong>
      <small>Just Now</small>
      <button type="button" class="btn-close" data-bs-dismiss="toast"></button>
    </div>
    <div class="toast-body">
      Notice: New Teaching Instruction Letters will begin to be issued on <b>15 February 2026</b> for the upcoming
	  semester of <i>March 2026 - August 2026</i>.
    </div>
  </div>
</div>
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const toast = new bootstrap.Toast(autoToast, { autohide: false });
    toast.show();
  });
</script>
	</div>
